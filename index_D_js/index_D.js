...
$('#burger').click(function () {
    ...
    if ($('#burger>img').attr('src') == './index_D_img/burger.svg') {
        ...
        $('#burger>img').attr('src', './index_D_img/burger.svg');
...
$('#backtogo').click(function () {
    ...
    var b1 = window.innerWidth; //瀏覽器範圍含滾軸
    if(b1 <= 920){
        $('.title img').css('width','7vw');
        $('#qa-box a img').css('width','9vw');
    }
    if(b1 <= 420){
        $('.title img').css('width','10vw');
        $('#qa-box a img').css('width','12vw');
    }
